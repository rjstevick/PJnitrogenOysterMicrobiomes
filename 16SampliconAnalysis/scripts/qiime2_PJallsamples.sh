...
echo "QIIME2 bash script for Point Judith V6 samples started running at: "; date
...
cd /data/marine_diseases_lab/rebecca/PJsequencing/amplicons16S

# Put metadata file names here
METADATA="PJ_V6Samples_Metadata.txt"
MANIFEST="sample-manifest_PJ_V6"
CLASSIFIERV6="/data/marine_diseases_lab/rebecca/PJsequencing/amplicons16S/db/classifier-V6-silva-138-99.qza"
CLASSIFIERfull="/data/marine_diseases_lab/rebecca/PJsequencing/amplicons16S/db/classifier-silva-138-99-nb.qza"
